...
{
	/// <summary>
	/// 数据访问类:tsuhan_scgl_iqc_wxl
	/// </summary>
	public partial class tsuhan_scgl_iqc_wxl
	{
		public tsuhan_scgl_iqc_wxl()
		{}
		#region  BasicMethod
		...
		public bool Exists(string pch)
		{
			...
			strSql.Append("select count(1) from tsuhan_scgl_iqc_wxl");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Maticsoft.Model.tsuhan_scgl_iqc_wxl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tsuhan_scgl_iqc_wxl(");
			strSql.Append("id,pch,jylx,gysdm,rkdh,dhrq,sl,wlmc,wlbm,ggxhbc,pcsl,cjybl,other,cybz,aql,qjyn,okrate,wg_jyyjbz,wg_cjybsl,wg_okng,wg_sign,wg_ngindex,hg_jyyjbz,hg_cjybsl,hg_okng,hg_sign,hg_ngindex,bs_okng,bs_sign,bs_ngindex,bz_okng,bz_sign,bz_ngindex,report,report_sign,ngdescription,checkjg,checker,checkertime,groupleader,grouptime,remarks,ohxp,lgxsjP,ggsbh,check1name,check1value,check1result,check2name,check2value,check2result,check3name,check3value,check3result,check4name,check4value,check4result,check5name,check5value,check5result,check6name,check6value,check6result,check7name,check7value,check7result,check8name,check8value,check8result,check9name,check9value,check9result,check10name,check10value,check10result,recorder,recordtime)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@hg_jyyjbz", SqlDbType.Char,100),
					new SqlParameter("@hg_cjybsl", SqlDbType.Int,4),
					new SqlParameter("@hg_okng", SqlDbType.Char,10),
					new SqlParameter("@hg_sign", SqlDbType.Char,10),
					new SqlParameter("@hg_ngindex", SqlDbType.Char,200),
					...
					new SqlParameter("@ohxp", SqlDbType.Char,30),
					new SqlParameter("@lgxsjP", SqlDbType.Float,8),
			...
			parameters[22].Value = model.hg_jyyjbz;
			parameters[23].Value = model.hg_cjybsl;
			parameters[24].Value = model.hg_okng;
			parameters[25].Value = model.hg_sign;
			parameters[26].Value = model.hg_ngindex;
			...
			parameters[42].Value = model.ohxp;
			parameters[43].Value = model.lgxsjP;
			parameters[44].Value = model.ggsbh;
			parameters[45].Value = model.check1name;
			parameters[46].Value = model.check1value;
			parameters[47].Value = model.check1result;
			...
			parameters[57].Value = model.check5name;
			parameters[58].Value = model.check5value;
			parameters[59].Value = model.check5result;
			parameters[60].Value = model.check6name;
			parameters[61].Value = model.check6value;
			parameters[62].Value = model.check6result;
			parameters[63].Value = model.check7name;
			parameters[64].Value = model.check7value;
			parameters[65].Value = model.check7result;
			parameters[66].Value = model.check8name;
			parameters[67].Value = model.check8value;
			parameters[68].Value = model.check8result;
			parameters[69].Value = model.check9name;
			parameters[70].Value = model.check9value;
			parameters[71].Value = model.check9result;
			parameters[72].Value = model.check10name;
			parameters[73].Value = model.check10value;
			parameters[74].Value = model.check10result;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tsuhan_scgl_iqc_wxl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tsuhan_scgl_iqc_wxl set ");
			strSql.Append("id=@id,");
			...
			strSql.Append("hg_jyyjbz=@hg_jyyjbz,");
			strSql.Append("hg_cjybsl=@hg_cjybsl,");
			strSql.Append("hg_okng=@hg_okng,");
			strSql.Append("hg_sign=@hg_sign,");
			strSql.Append("hg_ngindex=@hg_ngindex,");
			...
			strSql.Append("ohxp=@ohxp,");
			strSql.Append("lgxsjP=@lgxsjP,");
			...
			parameters[21].Value = model.hg_jyyjbz;
			parameters[22].Value = model.hg_cjybsl;
			parameters[23].Value = model.hg_okng;
			parameters[24].Value = model.hg_sign;
			parameters[25].Value = model.hg_ngindex;
			...
			parameters[41].Value = model.ohxp;
			parameters[42].Value = model.lgxsjP;
			...
			parameters[53].Value = model.check4name;
			parameters[54].Value = model.check4value;
			parameters[55].Value = model.check4result;
			parameters[56].Value = model.check5name;
			parameters[57].Value = model.check5value;
			parameters[58].Value = model.check5result;
			parameters[59].Value = model.check6name;
			parameters[60].Value = model.check6value;
			parameters[61].Value = model.check6result;
			parameters[62].Value = model.check7name;
			parameters[63].Value = model.check7value;
			parameters[64].Value = model.check7result;
			parameters[65].Value = model.check8name;
			parameters[66].Value = model.check8value;
			parameters[67].Value = model.check8result;
			parameters[68].Value = model.check9name;
			parameters[69].Value = model.check9value;
			parameters[70].Value = model.check9result;
			parameters[71].Value = model.check10name;
			parameters[72].Value = model.check10value;
			parameters[73].Value = model.check10result;
		...
		public bool Delete(string pch)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tsuhan_scgl_iqc_wxl ");
			strSql.Append(" where pch=@pch ");
			SqlParameter[] parameters = {
					new SqlParameter("@pch", SqlDbType.Char,30)			};
			parameters[0].Value = pch;
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_wxl GetModel(string pch)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,pch,jylx,gysdm,rkdh,dhrq,sl,wlmc,wlbm,ggxhbc,pcsl,cjybl,other,cybz,aql,qjyn,okrate,wg_jyyjbz,wg_cjybsl,wg_okng,wg_sign,wg_ngindex,hg_jyyjbz,hg_cjybsl,hg_okng,hg_sign,hg_ngindex,bs_okng,bs_sign,bs_ngindex,bz_okng,bz_sign,bz_ngindex,report,report_sign,ngdescription,checkjg,checker,checkertime,groupleader,grouptime,remarks,ohxp,lgxsjP,ggsbh,check1name,check1value,check1result,check2name,check2value,check2result,check3name,check3value,check3result,check4name,check4value,check4result,check5name,check5value,check5result,check6name,check6value,check6result,check7name,check7value,check7result,check8name,check8value,check8result,check9name,check9value,check9result,check10name,check10value,check10result,recorder,recordtime from tsuhan_scgl_iqc_wxl ");
			strSql.Append(" where pch=@pch ");
			SqlParameter[] parameters = {
					new SqlParameter("@pch", SqlDbType.Char,30)			};
			parameters[0].Value = pch;

			Maticsoft.Model.tsuhan_scgl_iqc_wxl model=new Maticsoft.Model.tsuhan_scgl_iqc_wxl();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_wxl DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tsuhan_scgl_iqc_wxl model=new Maticsoft.Model.tsuhan_scgl_iqc_wxl();
			if (row != null)
			{
				...
				if(row["hg_jyyjbz"]!=null)
				{
					model.hg_jyyjbz=row["hg_jyyjbz"].ToString();
				}
				if(row["hg_cjybsl"]!=null && row["hg_cjybsl"].ToString()!="")
				{
					model.hg_cjybsl=int.Parse(row["hg_cjybsl"].ToString());
				}
				if(row["hg_okng"]!=null)
				{
					model.hg_okng=row["hg_okng"].ToString();
				}
				if(row["hg_sign"]!=null)
				{
					model.hg_sign=row["hg_sign"].ToString();
				}
				if(row["hg_ngindex"]!=null)
				{
					model.hg_ngindex=row["hg_ngindex"].ToString();
				}
				if(row["bs_okng"]!=null)
				{
				...
				if(row["ohxp"]!=null)
				{
					model.ohxp=row["ohxp"].ToString();
				}
				if(row["lgxsjP"]!=null && row["lgxsjP"].ToString()!="")
				{
					model.lgxsjP=decimal.Parse(row["lgxsjP"].ToString());
				}
				if(row["ggsbh"]!=null)
				{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM tsuhan_scgl_iqc_wxl ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tsuhan_scgl_iqc_wxl T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tsuhan_scgl_iqc_wxl";
