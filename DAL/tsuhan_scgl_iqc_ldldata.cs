...
namespace Maticsoft.DAL
{
	...
	public partial class tsuhan_scgl_iqc_ldldata
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tsuhan_scgl_iqc_ldldata"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from tsuhan_scgl_iqc_ldldata");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Maticsoft.Model.tsuhan_scgl_iqc_ldldata model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tsuhan_scgl_iqc_ldldata(");
			...
			parameters[30].Value = model.check8name;
			parameters[31].Value = model.check8value;
			parameters[32].Value = model.check8result;
			parameters[33].Value = model.check8bz;
			parameters[34].Value = model.recorder;
			parameters[35].Value = model.recordtime;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tsuhan_scgl_iqc_ldldata model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tsuhan_scgl_iqc_ldldata set ");
			...
			parameters[29].Value = model.check8name;
			parameters[30].Value = model.check8value;
			parameters[31].Value = model.check8result;
			parameters[32].Value = model.check8bz;
			parameters[33].Value = model.recorder;
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tsuhan_scgl_iqc_ldldata ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_ldldata DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tsuhan_scgl_iqc_ldldata model=new Maticsoft.Model.tsuhan_scgl_iqc_ldldata();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM tsuhan_scgl_iqc_ldldata ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tsuhan_scgl_iqc_ldldata T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tsuhan_scgl_iqc_ldldata";
