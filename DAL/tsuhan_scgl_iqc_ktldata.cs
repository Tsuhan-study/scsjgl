...
{
	/// <summary>
	/// 数据访问类:tsuhan_scgl_iqc_ktldata
	/// </summary>
	public partial class tsuhan_scgl_iqc_ktldata
	{
		public tsuhan_scgl_iqc_ktldata()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tsuhan_scgl_iqc_ktldata"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from tsuhan_scgl_iqc_ktldata");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Maticsoft.Model.tsuhan_scgl_iqc_ktldata model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tsuhan_scgl_iqc_ktldata(");
			strSql.Append("id,pch,check1name,check1value,check1result,check2name,check2value,check2result,check3name,check3value,check3result,check4name,check4value,check4result,check5name,check5value,check5result,check6name,check6value,check6result,check7name,check7value,check7result,check8name,check8value,check8result,check9name,check9value,check9result,check10name,check10value,check10result,check11name,check11value,check11result,check12name,check12value,check12result,check13name,check13value,check13result,check14name,check14value,check14result,recorder,recordtime)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@check10name", SqlDbType.NChar,10),
					new SqlParameter("@check10value", SqlDbType.Float,8),
					new SqlParameter("@check10result", SqlDbType.NChar,10),
					new SqlParameter("@check11name", SqlDbType.NChar,10),
					new SqlParameter("@check11value", SqlDbType.NChar,10),
					new SqlParameter("@check11result", SqlDbType.NChar,10),
					new SqlParameter("@check12name", SqlDbType.NChar,10),
					new SqlParameter("@check12value", SqlDbType.NChar,10),
					new SqlParameter("@check12result", SqlDbType.NChar,10),
					new SqlParameter("@check13name", SqlDbType.NChar,10),
					new SqlParameter("@check13value", SqlDbType.NChar,10),
					new SqlParameter("@check13result", SqlDbType.NChar,10),
					new SqlParameter("@check14name", SqlDbType.NChar,10),
					new SqlParameter("@check14value", SqlDbType.NChar,10),
					new SqlParameter("@check14result", SqlDbType.NChar,10),
			...
			parameters[35].Value = model.check12name;
			parameters[36].Value = model.check12value;
			parameters[37].Value = model.check12result;
			parameters[38].Value = model.check13name;
			parameters[39].Value = model.check13value;
			parameters[40].Value = model.check13result;
			parameters[41].Value = model.check14name;
			parameters[42].Value = model.check14value;
			parameters[43].Value = model.check14result;
			parameters[44].Value = model.recorder;
			parameters[45].Value = model.recordtime;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tsuhan_scgl_iqc_ktldata model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tsuhan_scgl_iqc_ktldata set ");
			...
			strSql.Append("check12name=@check12name,");
			strSql.Append("check12value=@check12value,");
			strSql.Append("check12result=@check12result,");
			strSql.Append("check13name=@check13name,");
			strSql.Append("check13value=@check13value,");
			strSql.Append("check13result=@check13result,");
			strSql.Append("check14name=@check14name,");
			strSql.Append("check14value=@check14value,");
			strSql.Append("check14result=@check14result,");
			...
			parameters[34].Value = model.check12name;
			parameters[35].Value = model.check12value;
			parameters[36].Value = model.check12result;
			parameters[37].Value = model.check13name;
			parameters[38].Value = model.check13value;
			parameters[39].Value = model.check13result;
			parameters[40].Value = model.check14name;
			parameters[41].Value = model.check14value;
			parameters[42].Value = model.check14result;
			parameters[43].Value = model.recorder;
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tsuhan_scgl_iqc_ktldata ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_ktldata GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,pch,check1name,check1value,check1result,check2name,check2value,check2result,check3name,check3value,check3result,check4name,check4value,check4result,check5name,check5value,check5result,check6name,check6value,check6result,check7name,check7value,check7result,check8name,check8value,check8result,check9name,check9value,check9result,check10name,check10value,check10result,check11name,check11value,check11result,check12name,check12value,check12result,check13name,check13value,check13result,check14name,check14value,check14result,recorder,recordtime from tsuhan_scgl_iqc_ktldata ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;

			Maticsoft.Model.tsuhan_scgl_iqc_ktldata model=new Maticsoft.Model.tsuhan_scgl_iqc_ktldata();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_ktldata DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tsuhan_scgl_iqc_ktldata model=new Maticsoft.Model.tsuhan_scgl_iqc_ktldata();
			if (row != null)
			{
				...
				if(row["check12name"]!=null)
				{
					model.check12name=row["check12name"].ToString();
				}
				if(row["check12value"]!=null)
				{
					model.check12value=row["check12value"].ToString();
				}
				if(row["check12result"]!=null)
				{
					model.check12result=row["check12result"].ToString();
				}
				if(row["check13name"]!=null)
				{
					model.check13name=row["check13name"].ToString();
				}
				if(row["check13value"]!=null)
				{
					model.check13value=row["check13value"].ToString();
				}
				if(row["check13result"]!=null)
				{
					model.check13result=row["check13result"].ToString();
				}
				if(row["check14name"]!=null)
				{
					model.check14name=row["check14name"].ToString();
				}
				if(row["check14value"]!=null)
				{
					model.check14value=row["check14value"].ToString();
				}
				if(row["check14result"]!=null)
				{
					model.check14result=row["check14result"].ToString();
				}
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM tsuhan_scgl_iqc_ktldata ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tsuhan_scgl_iqc_ktldata T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tsuhan_scgl_iqc_ktldata";
