...
{
	/// <summary>
	/// 数据访问类:tsuhan_scgl_iqc_cxl
	/// </summary>
	public partial class tsuhan_scgl_iqc_cxl
	{
		public tsuhan_scgl_iqc_cxl()
		{}
		#region  BasicMethod
		...
		public bool Exists(string pch)
		{
			...
			strSql.Append("select count(1) from tsuhan_scgl_iqc_cxl");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Maticsoft.Model.tsuhan_scgl_iqc_cxl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tsuhan_scgl_iqc_cxl(");
			strSql.Append("id,pch,jylx,gysdm,rkdh,dhrq,sl,wlmc,wlbm,ggxhbc,pcsl,cjybl,other,cybz,aql,qjyn,okrate,checkjg,checker,checkertime,groupleader,grouptime,remarks,ggsbh,check1name,check1value,check1result,check2name,check2value,check2result,check3name,check3value,check3result,check4name,check4value,check4result,check5name,check5value,check5result,check6name,check6value,check6result,check7name,check7value,check7result,check8name,check8value,check8result,check9name,check9value,check9result,check10name,check10value,check10result,recorder,recordtime)");
			...
			parameters[17].Value = model.checkjg;
			parameters[18].Value = model.checker;
			parameters[19].Value = model.checkertime;
			parameters[20].Value = model.groupleader;
			parameters[21].Value = model.grouptime;
			parameters[22].Value = model.remarks;
			parameters[23].Value = model.ggsbh;
			parameters[24].Value = model.check1name;
			parameters[25].Value = model.check1value;
			parameters[26].Value = model.check1result;
			parameters[27].Value = model.check2name;
			parameters[28].Value = model.check2value;
			parameters[29].Value = model.check2result;
			parameters[30].Value = model.check3name;
			parameters[31].Value = model.check3value;
			parameters[32].Value = model.check3result;
			parameters[33].Value = model.check4name;
			parameters[34].Value = model.check4value;
			parameters[35].Value = model.check4result;
			parameters[36].Value = model.check5name;
			parameters[37].Value = model.check5value;
			parameters[38].Value = model.check5result;
			parameters[39].Value = model.check6name;
			parameters[40].Value = model.check6value;
			parameters[41].Value = model.check6result;
			parameters[42].Value = model.check7name;
			parameters[43].Value = model.check7value;
			parameters[44].Value = model.check7result;
			parameters[45].Value = model.check8name;
			parameters[46].Value = model.check8value;
			parameters[47].Value = model.check8result;
			parameters[48].Value = model.check9name;
			parameters[49].Value = model.check9value;
			parameters[50].Value = model.check9result;
			parameters[51].Value = model.check10name;
			parameters[52].Value = model.check10value;
			parameters[53].Value = model.check10result;
			parameters[54].Value = model.recorder;
			parameters[55].Value = model.recordtime;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tsuhan_scgl_iqc_cxl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tsuhan_scgl_iqc_cxl set ");
			strSql.Append("id=@id,");
			...
			parameters[16].Value = model.checkjg;
			parameters[17].Value = model.checker;
			parameters[18].Value = model.checkertime;
			parameters[19].Value = model.groupleader;
			parameters[20].Value = model.grouptime;
			parameters[21].Value = model.remarks;
			parameters[22].Value = model.ggsbh;
			parameters[23].Value = model.check1name;
			parameters[24].Value = model.check1value;
			parameters[25].Value = model.check1result;
			parameters[26].Value = model.check2name;
			parameters[27].Value = model.check2value;
			parameters[28].Value = model.check2result;
			parameters[29].Value = model.check3name;
			parameters[30].Value = model.check3value;
			parameters[31].Value = model.check3result;
			parameters[32].Value = model.check4name;
			parameters[33].Value = model.check4value;
			parameters[34].Value = model.check4result;
			parameters[35].Value = model.check5name;
			parameters[36].Value = model.check5value;
			parameters[37].Value = model.check5result;
			parameters[38].Value = model.check6name;
			parameters[39].Value = model.check6value;
			parameters[40].Value = model.check6result;
			parameters[41].Value = model.check7name;
			parameters[42].Value = model.check7value;
			parameters[43].Value = model.check7result;
			parameters[44].Value = model.check8name;
			parameters[45].Value = model.check8value;
			parameters[46].Value = model.check8result;
			parameters[47].Value = model.check9name;
			parameters[48].Value = model.check9value;
			parameters[49].Value = model.check9result;
			parameters[50].Value = model.check10name;
			parameters[51].Value = model.check10value;
			parameters[52].Value = model.check10result;
			parameters[53].Value = model.recorder;
			parameters[54].Value = model.pch;
		...
		public bool Delete(string pch)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tsuhan_scgl_iqc_cxl ");
			strSql.Append(" where pch=@pch ");
			SqlParameter[] parameters = {
					new SqlParameter("@pch", SqlDbType.NChar,30)			};
			parameters[0].Value = pch;
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_cxl GetModel(string pch)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,pch,jylx,gysdm,rkdh,dhrq,sl,wlmc,wlbm,ggxhbc,pcsl,cjybl,other,cybz,aql,qjyn,okrate,checkjg,checker,checkertime,groupleader,grouptime,remarks,ggsbh,check1name,check1value,check1result,check2name,check2value,check2result,check3name,check3value,check3result,check4name,check4value,check4result,check5name,check5value,check5result,check6name,check6value,check6result,check7name,check7value,check7result,check8name,check8value,check8result,check9name,check9value,check9result,check10name,check10value,check10result,recorder,recordtime from tsuhan_scgl_iqc_cxl ");
			strSql.Append(" where pch=@pch ");
			SqlParameter[] parameters = {
					new SqlParameter("@pch", SqlDbType.NChar,30)			};
			parameters[0].Value = pch;

			Maticsoft.Model.tsuhan_scgl_iqc_cxl model=new Maticsoft.Model.tsuhan_scgl_iqc_cxl();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_cxl DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tsuhan_scgl_iqc_cxl model=new Maticsoft.Model.tsuhan_scgl_iqc_cxl();
			if (row != null)
			{
				...
				if(row["check9value"]!=null && row["check9value"].ToString()!="")
				{
					model.check9value=decimal.Parse(row["check9value"].ToString());
				}
				...
				if(row["check10value"]!=null && row["check10value"].ToString()!="")
				{
					model.check10value=decimal.Parse(row["check10value"].ToString());
				}
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM tsuhan_scgl_iqc_cxl ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tsuhan_scgl_iqc_cxl T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tsuhan_scgl_iqc_cxl";
