...
namespace Maticsoft.DBUtility
{
    ...
    public class DbHelperSQLP
    {
        ...
        public DataTable QueryTable(string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand();
        ...
        public DataTable GetTable(string sql, List<SqlParameter> pars)
        {
            SqlConnection constr = new SqlConnection(connectionString);
        ...
        public DataSet Query(string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                {
                    ...
                    {
                        throw new Exception(ex.Message);//if附近有语法错误
                    }
                    return ds;
                }
            }
