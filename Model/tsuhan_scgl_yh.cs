...
namespace Maticsoft.Model
{
    ...
    public partial class tsuhan_scgl_yh
    {
        ...
        private string _离职原因;
        private string _是否工资卡;
        private string _批注;
        private string _介绍人;
        ...
        private string _身份证地址;
        private string _现住址;
        private decimal? _电话;
        private string _紧急联系人;
        private decimal? _紧急联系人电话;
        private string _婚姻状况;
        private string _民族;
        private string _籍贯;
        private string _户籍;
        private string _是否转正;
        private DateTime? _转正时间;
        private string _是否购买社保;
        private string _购买社保时间;
        private string _是否购买商保;
        private string _人事资料情况;
        private string _是否签订合同;
        private string _合同年限;
        private DateTime? _起始日期;
        private string _终止日期;
        private string _合同状态;
        private string _合同状态备注;
        private string _备注;
