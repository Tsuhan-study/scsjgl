...
namespace Maticsoft.DAL
{
	...
	public partial class tsuhan_scgl_iqc_glql
	{
		...
		public bool Exists(string pch)
		{
			...
			strSql.Append("select count(1) from tsuhan_scgl_iqc_glql");
		...
		public bool Add(Maticsoft.Model.tsuhan_scgl_iqc_glql model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@lx", SqlDbType.Char,30),
					new SqlParameter("@chic", SqlDbType.Char,10),
					new SqlParameter("@kj", SqlDbType.Char,30),
					new SqlParameter("@bc", SqlDbType.Int,4),
					new SqlParameter("@ggxhbc", SqlDbType.Char,50),
			...
			parameters[11].Value = model.kj;
			parameters[12].Value = model.bc;
			parameters[13].Value = model.ggxhbc;
			parameters[14].Value = model.cjybl;
			parameters[15].Value = model.other;
			parameters[16].Value = model.cstj;
			parameters[17].Value = model.cstjxpxh;
			parameters[18].Value = model.cstjgwpl;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tsuhan_scgl_iqc_glql model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tsuhan_scgl_iqc_glql set ");
			strSql.Append("id=@id,");
			...
			parameters[8].Value = model.lx;
			parameters[9].Value = model.chic;
			parameters[10].Value = model.kj;
			parameters[11].Value = model.bc;
			parameters[12].Value = model.ggxhbc;
			parameters[13].Value = model.cjybl;
		...
		public bool Delete(string pch)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tsuhan_scgl_iqc_glql ");
			strSql.Append(" where pch=@pch ");
			SqlParameter[] parameters = {
					new SqlParameter("@pch", SqlDbType.Char,30)			};
			parameters[0].Value = pch;
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_glql GetModel(string pch)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,pch,jylx,gysdm,rkdh,dhrq,sl,wlmc,thbc,lx,chic,kj,bc,ggxhbc,cjybl,other,cstj,cstjxpxh,cstjgwpl,cybz,aql,qjyn,okrate,wg_jyyjbz,wg_cjybsl,wg_okng,wg_sign,wg_ngindex,bs_okng,bs_sign,bs_ngindex,bz_okng,bz_sign,bz_ngindex,report,report_sign,ngdescription,checkjg,checker,checkertime,groupleader,grouptime,remarks,ggsbh,check1name,check1value,check1result,check1bz,check2name,check2value,check2result,check2bz,check3name,check3value,check3result,check3bz,check4name,check4value,check4result,check4bz,check5name,check5value,check5result,check5bz,check6name,check6value,check6result,check6bz,check7name,check7value,check7result,check7bz,recorder,recordtime from tsuhan_scgl_iqc_glql ");
			strSql.Append(" where pch=@pch ");
			SqlParameter[] parameters = {
					new SqlParameter("@pch", SqlDbType.Char,30)			};
			parameters[0].Value = pch;

			Maticsoft.Model.tsuhan_scgl_iqc_glql model=new Maticsoft.Model.tsuhan_scgl_iqc_glql();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_glql DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tsuhan_scgl_iqc_glql model=new Maticsoft.Model.tsuhan_scgl_iqc_glql();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM tsuhan_scgl_iqc_glql ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tsuhan_scgl_iqc_glql T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tsuhan_scgl_iqc_glql";
