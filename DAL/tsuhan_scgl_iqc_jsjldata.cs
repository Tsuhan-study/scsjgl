...
{
	/// <summary>
	/// 数据访问类:tsuhan_scgl_iqc_jsjldata
	/// </summary>
	public partial class tsuhan_scgl_iqc_jsjldata
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tsuhan_scgl_iqc_jsjldata"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from tsuhan_scgl_iqc_jsjldata");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Maticsoft.Model.tsuhan_scgl_iqc_jsjldata model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tsuhan_scgl_iqc_jsjldata(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tsuhan_scgl_iqc_jsjldata model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tsuhan_scgl_iqc_jsjldata set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tsuhan_scgl_iqc_jsjldata ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_jsjldata GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,pch,check1name,check1value,check1result,check2name,check2value,check2result,check3name,check3value,check3result,check4name,check4value,check4result,check5name,check5value,check5result,check6name,check6value,check6result,check7name,check7value,check7result,check8name,check8value,check8result,check9name,check9value,check9result,check10name,check10value,check10result,recorder,recordtime from tsuhan_scgl_iqc_jsjldata ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;

			Maticsoft.Model.tsuhan_scgl_iqc_jsjldata model=new Maticsoft.Model.tsuhan_scgl_iqc_jsjldata();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_jsjldata DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tsuhan_scgl_iqc_jsjldata model=new Maticsoft.Model.tsuhan_scgl_iqc_jsjldata();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM tsuhan_scgl_iqc_jsjldata ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tsuhan_scgl_iqc_jsjldata T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tsuhan_scgl_iqc_jsjldata";
