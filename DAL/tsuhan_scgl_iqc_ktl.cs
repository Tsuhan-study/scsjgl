...
namespace Maticsoft.DAL
{
	...
	public partial class tsuhan_scgl_iqc_ktl
	{
		...
		public bool Exists(string pch)
		{
			...
			strSql.Append("select count(1) from tsuhan_scgl_iqc_ktl");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Maticsoft.Model.tsuhan_scgl_iqc_ktl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tsuhan_scgl_iqc_ktl(");
			...
			parameters[71].Value = model.check12name;
			parameters[72].Value = model.check12value;
			parameters[73].Value = model.check12result;
			parameters[74].Value = model.check13name;
			parameters[75].Value = model.check13value;
			parameters[76].Value = model.check13result;
			parameters[77].Value = model.check14name;
			parameters[78].Value = model.check14value;
			parameters[79].Value = model.check14result;
			parameters[80].Value = model.recorder;
			parameters[81].Value = model.recordtime;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tsuhan_scgl_iqc_ktl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tsuhan_scgl_iqc_ktl set ");
			strSql.Append("id=@id,");
			...
			parameters[70].Value = model.check12name;
			parameters[71].Value = model.check12value;
			parameters[72].Value = model.check12result;
			parameters[73].Value = model.check13name;
			parameters[74].Value = model.check13value;
			parameters[75].Value = model.check13result;
			parameters[76].Value = model.check14name;
			parameters[77].Value = model.check14value;
			parameters[78].Value = model.check14result;
			parameters[79].Value = model.recorder;
			parameters[80].Value = model.pch;
		...
		public bool Delete(string pch)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tsuhan_scgl_iqc_ktl ");
			strSql.Append(" where pch=@pch ");
			SqlParameter[] parameters = {
					new SqlParameter("@pch", SqlDbType.Char,30)			};
			parameters[0].Value = pch;
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_ktl GetModel(string pch)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,pch,jylx,gysdm,rkdh,dhrq,sl,wlmc,wlbm,ggxhbc,pcsl,cjybl,other,cybz,aql,qjyn,okrate,wg_jyyjbz,wg_cjybsl,wg_okng,wg_sign,wg_ngindex,bs_okng,bs_sign,bs_ngindex,bz_okng,bz_sign,bz_ngindex,report,report_sign,ngdescription,checkjg,checker,checkertime,groupleader,grouptime,remarks,ggsbh,check1name,check1value,check1result,check2name,check2value,check2result,check3name,check3value,check3result,check4name,check4value,check4result,check5name,check5value,check5result,check6name,check6value,check6result,check7name,check7value,check7result,check8name,check8value,check8result,check9name,check9value,check9result,check10name,check10value,check10result,check11name,check11value,check11result,check12name,check12value,check12result,check13name,check13value,check13result,check14name,check14value,check14result,recorder,recordtime from tsuhan_scgl_iqc_ktl ");
			strSql.Append(" where pch=@pch ");
			SqlParameter[] parameters = {
					new SqlParameter("@pch", SqlDbType.Char,30)			};
			parameters[0].Value = pch;

			Maticsoft.Model.tsuhan_scgl_iqc_ktl model=new Maticsoft.Model.tsuhan_scgl_iqc_ktl();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tsuhan_scgl_iqc_ktl DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tsuhan_scgl_iqc_ktl model=new Maticsoft.Model.tsuhan_scgl_iqc_ktl();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM tsuhan_scgl_iqc_ktl ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tsuhan_scgl_iqc_ktl T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tsuhan_scgl_iqc_ktl";
